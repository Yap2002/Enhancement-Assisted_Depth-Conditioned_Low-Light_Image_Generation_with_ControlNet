    ...
    def preprocess_train(examples):
        ...
        for img in examples[conditioning_image_column]:
            if hasattr(img, "convert"):
                conditioning_images.append(img.convert("RGB"))
            else:
                import os
                from PIL import Image
                p = img if os.path.isabs(img) else os.path.join(args.train_data_dir, img)
                conditioning_images.append(Image.open(p).convert("RGB"))
